...
using peloton.Dialogs.Sample;
using peloton.Dialogs.Shared;
using peloton.Dialogs.Shared.DialogOptions;
using peloton.Dialogs.Shared.Resources;
using peloton.ServiceClients;

namespace peloton.Dialogs.Main
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task RouteAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            localeConfig.LuisServices.TryGetValue("peloton", out var luisService);
            ...
            else
            {
                ...
                var result = await luisService.RecognizeAsync<pelotonLU>(dc.Context, CancellationToken.None);
